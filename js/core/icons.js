...
const PATHS = {
  ...
  phone: '<path d="M6.6 3.6h3.1l1.3 3.4-2.1 1.2a11.4 11.4 0 0 0 5.4 5.4l1.2-2.1 3.4 1.3v3.1c0 .9-.7 1.6-1.6 1.6C8.8 17.5 3 11.7 3 5.2c0-.9.7-1.6 1.6-1.6Z"/>',
  radio: '<path d="M5 8.5h14a2 2 0 0 1 2 2V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8.5a2 2 0 0 1 2-2Z"/><path d="m8 8.5 8-5"/><circle cx="8.5" cy="14.5" r="1.6"/><path d="M12.5 13h6M12.5 16.5h4"/>',
  users: '<path d="M16.4 20v-1.4a3.4 3.4 0 0 0-3.4-3.4H7.4A3.4 3.4 0 0 0 4 18.6V20"/><circle cx="10.2" cy="8.2" r="3"/><path d="M20 20v-1.4a3.4 3.4 0 0 0-2.6-3.3M16.2 5.1a3 3 0 0 1 0 5.8"/>',
  shield: '<path d="M12 2.8 3.6 7v6c0 4.6 3.5 7.6 8.4 9.2 4.9-1.6 8.4-4.6 8.4-9.2V7L12 2.8Z"/>',
  lock: '<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V8a4 4 0 0 1 8 0v3"/>',
  wave: '<path d="M3 12c2-4 3.2-4 5 0s3.2 4 5 0 3.2-4 5 0 3 4 3 0"/>',
  hash: '<path d="M9 4 6.5 20M17.5 4 15 20M4 9.5h16M3.5 14.5h16"/>',
  truck: '<path d="M3 7.5h11v9H3z"/><path d="M14 11h4.2L21 14.2V16.5h-7"/><circle cx="7" cy="17.6" r="1.5"/><circle cx="17.2" cy="17.6" r="1.5"/>',
  pulse: '<path d="M3 12h3.2l2.2-6 3.2 12 2.4-6H21"/>',
  key: '<circle cx="8.2" cy="14.2" r="4.2"/><path d="M12 14.2h9.2M18.2 14.2v3.2M20.6 14.2V16"/>',
};
